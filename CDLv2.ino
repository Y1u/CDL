 ...
 * 
 * Update of CDL V1, added clock synchronization
 * 
 * For more info:
 * http://yl4bs.blogspot.fr/2016/12/cheap-data-logger-v2-arduino-clock.html
 * 
 */
...
#define OFFSET 25       //Offset for first column text allignment on screen
...
void setup() {
  Serial.begin(9600);
  //set function to call when clock synchronization required
...
// Functions for clock syncronization from time library
